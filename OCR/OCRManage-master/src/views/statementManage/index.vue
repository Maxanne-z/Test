    ...
    <div class="report-container">
        ...
        <el-row class="operation-bar">
            <el-col :span="24" class="flex-right">
                <span>报表类别</span>
                <el-select v-model="selectedReportType" placeholder="请选择"
        ...
        <!-- 动态表格 -->
        <el-table :data="filteredTableData" stripe style="width: 100%; margin-top: 15px" ref="multipleTable"
            ...
            <el-table-column prop="unitProject" label="单位工程" width="200" align="center"></el-table-column>
