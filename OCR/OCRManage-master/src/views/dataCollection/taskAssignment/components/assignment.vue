        ...
        <el-card class="build-card">
          ...
          <el-row :gutter="2" class="spaced-row">
            ...
            <el-col :span="4">
              ...
              <el-dialog title="检验批容量编辑" :visible.sync="dialogFormVisible1">
                <el-table :data="gridData">
                  ...
                  <el-table-column property="operation" label="操作" align="center">
                    <el-button type="danger" @click="cancelRow1()">删除</el-button>
                  </el-table-column>
                </el-table>
        ...
        <template slot-scope="scope">
          ...
          <el-dialog title="设计值编辑" :visible.sync="dialogTableVisible2">
            <el-table :data="gridData">
              ...
              <el-table-column property="operation" label="操作" align="center">
                <el-button type="danger" @click="cancelRow2()">删除</el-button>
              </el-table-column>
            </el-table>
            <div slot="footer" class="dialog-footer">
