  ...
  <div>
    ...
    <div v-if="$route.name === 'RawMaterial'">
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column prop="dataId" label="批次" width="50" align="center"></el-table-column>
        ...
        <el-table-column prop="usePart" label="使用部位" width="150" align="center"></el-table-column>
        <el-table-column prop="diameter" label="钢筋直径（mm）" width="100" align="center"></el-table-column>
        <el-table-column prop="steelType" label="钢筋牌号" width="100" align="center"></el-table-column>
        <el-table-column prop="heatBatchNumber" label="炉批号" width="100" align="center"></el-table-column>
        <el-table-column prop="isPassed" label="是否合格" width="100" align="center"></el-table-column>
