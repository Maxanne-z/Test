...
<div>
		...
		<el-col :span="10">
			<el-card class="sub-card">
				<el-row :gutter="5" class="spaced-row">
					...
					<el-col :span="12">
						<el-input v-model="data1" placeholder="请输入分包单位" class="card-item-name"
							size="mini"></el-input>
					</el-col>
				</el-row>
				<el-row :gutter="5" class="spaced-row">
					...
					<el-col :span="12">
						<el-input v-model="data2" placeholder="请输入项目负责人" class="card-item-name"
							size="mini"></el-input>
					</el-col>
				</el-row>
				<el-row :gutter="5" class="spaced-row">
					...
					<el-col :span="12">
						<el-input v-model="data3" placeholder="请输入技术负责人" class="card-item-name"
							size="mini"></el-input>
					</el-col>
				</el-row>
			</el-card>
							...
							<el-table :data="tempGridData1">
								...
								<el-table-column property="source" label="来源" width="180" align="center">
									...
									<template slot-scope="scope">
										...
										<el-select v-model="scope.row.distribute" placeholder=""
											style="width: 150px;">

											<el-option v-for="item in optionsEdit" :key="item.value"
								...
								<el-table-column property="count" label="数量" width="180" align="center">
									...
									<template slot-scope="scope">
										...
										<el-input v-model="scope.row.count" placeholder=""
								...
								<el-table-column property="info" label="其他信息" width="180" align="center">
									...
									<template slot-scope="scope">
										...
										<el-input v-model="scope.row.info" placeholder=""
											style="width: 150px;"></el-input>
	...
	<el-table :data="tableData" stripe style="width: 100%" :row-class-name="rowClassName">
		...
		<el-table-column prop="project" label="验收项目" width="160" align="center">

		</el-table-column>

		<el-table-column prop="require" label="设计要求及规范规定" width="160" align="center">
		...
		<el-table-column prop="min" label="最小抽样批量" width="160" align="center">

		</el-table-column>

		<el-table-column prop="distribute" label="分发岗位" width="160" align="center">
		...
		<el-table-column label="设计值" align="center">
			...
			<template slot-scope="scope">
				...
				<el-button type="warning" @click="dialogTableVisible2 = true">编辑</el-button>
				...
				<el-dialog title="设计值编辑" :visible.sync="dialogTableVisible2" :show-close="false">
					...
					<el-table :data="tempGridData2">
						...
						<el-table-column property="count" label="采样部位" width="220" align="center">

							<template slot-scope="scope">

								<el-input v-model="scope.row.part" placeholder=""
									style="width: 150px;"></el-input>
						...
						<el-table-column property="count" label="设计值" width="220" align="center">
...
confirm1() {
	...
	this.gridData1 = JSON.parse(JSON.stringify(this.tempGridData1));
...
updateInspectionBatchDisplay() {
	...
	if (this.gridData1.length > 0) {
		...
		if (sources.length > 0) {
			...
			this.inspectionBatchSource = sources.join('、');
